...
#>
function lint() {
    poetry run flake8 src\obscura_tools tests
}
...
#>
function coverage() {
    poetry run coverage run --source src\obscura_tools -m pytest
...
#>
function docs(){
    if (Test-Path ".\docs\obscura_tools.rst") { Remove-Item ".\docs\obscura_tools.rst" -Force }
